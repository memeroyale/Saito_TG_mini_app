...
.wallet-button-container {
    position: absolute; /* Ensure it stays relative to the main container */
    top: 140px; /* Adjusted to align with the yellow cross */
    right: 40px; /* Adjusted to pull closer to the inner layout */
    z-index: 1000; /* Ensure it appears on top */
}

.image-button {
    width: 50px; /* Keep button size consistent */
    height: auto;
