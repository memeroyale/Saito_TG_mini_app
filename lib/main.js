...
class DiddyMain {
  ...
  increaseScore() {
    ...
    if (this.onCooldown) {
        console.log("Cooldown active. Cannot increase score.");
    ...
    // Log current score and energy
    console.log(`Score: ${this.score}, Energy: ${this.energy}`);
    ...
    // Log the required clicks for the next level
    console.log(`Level: ${this.level}, Required Clicks for Next Level: ${requiredClicks}`);
    ...
    if (this.score >= requiredClicks) {
        ...
        console.log(`Not enough clicks to level up. Current score: ${this.score}, Required: ${requiredClicks}`);
    }
